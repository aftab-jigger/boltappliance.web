...
// Homepage category cards — one per top-level category (single source of
// truth: `src/lib/categories.js`). Links go to the new top-level routes
// (e.g. `/cooking`) rather than the legacy `/products/:category` path.
const categories = CATEGORIES.map((config) => ({
  id: config.slug,
  name: config.title,
  description: config.description,
  slug: config.slug,
  icon: categoryIcons[config.slug],
}));
